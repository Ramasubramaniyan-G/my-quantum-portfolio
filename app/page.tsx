...
import { useAmbientSound } from '@/hooks/ambientSound';
...
export default function Portfolio() {
  ...
  return (
    <div className="relative min-h-screen bg-[#020205] text-slate-300 font-sans selection:bg-cyan-500/30 selection:text-cyan-100 overflow-x-hidden">
      ...
      <button
        onClick={toggleSound}
        className={`fixed top-24 right-6 z-40 p-3 rounded-full backdrop-blur-md border transition-all duration-300 ${isPlaying
